...
struct CustomCarousel<Content: View,Item,ID>: View where Item: RandomAccessCollection,ID: Hashable,Item.Element: Equatable {
        ...
        GeometryReader { proxy in
            ...
            LazyHStack(spacing: spacing) {
                ForEach(items, id: id) { contents in
                    ...
                    // So Simple Removing the Spacing
                    ...
                    // And While Scrolling Setting it to 0, thus it will give some nice Circular Carousal Effect
    ...
    func onEnd(value: DragGesture.Value, cardWidth: CGFloat) {
        ...
        withAnimation(.easeInOut(duration: 0.25)) {
            ...
            // Why / 2 -> Because WeNeed Both Sides Need to Be Visible
            let extraSpace = (cardPadding / 2) - spacing
